  ...
  <?php if( get_theme_mod('ecommerce_hub_slider_hide') != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel"> 
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <?php if ( get_theme_mod('ecommerce_hub_slider_button_label','SHOP NOW') != '' && get_theme_mod('ecommerce_hub_slider_button',true) != '') {?>
                    <div class="more-btn">              
                      <a href="<?php esc_url(the_permalink()); ?>"><?php echo esc_html( get_theme_mod('ecommerce_hub_slider_button_label',__('SHOP NOW','ecommerce-hub')) ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('ecommerce_hub_slider_button_label',__('SHOP NOW','ecommerce-hub')) ); ?></span></a>
                    </div>
                  <?php }?>
                </div>
              </div>
        ...
        <?php if( get_theme_mod('ecommerce_hub_slider_indicator',true) != ''){ ?>

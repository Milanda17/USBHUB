...
<header role="banner">
	<h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'ecommerce-hub' ); ?></h2>
</header>
...
<?php else : ?>
	...
	<div class="read-moresec">
		<a href="<?php echo esc_url( home_url() ); ?>" class="button"><?php esc_html_e( 'Return to the home page', 'ecommerce-hub' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Return to the home page', 'ecommerce-hub' ); ?></span></a>
	</div>
<?php endif; ?>